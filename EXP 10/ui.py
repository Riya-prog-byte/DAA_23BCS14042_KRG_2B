...
# main.py is responsible for initialization.

try:
    # Try using a cleaner system font
...
# --- Theme Colors (Updated Palette) ---
THEME = {
    "bg": (15, 15, 25),          # Dark navy background
    "panel": (25, 25, 40),       # Slightly lighter panel
    "text": (220, 220, 255),      # Light blue-white text
    "text_dim": (150, 150, 180),   # Dimmer text for controls
    "text_header": (180, 180, 255),# Header text
    "button": (40, 40, 70),        # Dark blue button
    "button_hover": (70, 70, 110),     # Lighter blue hover
    "button_border": (100, 100, 255),# Bright blue border
    "grid_bg": (5, 5, 15),       # Very dark grid background
    "grid": (30, 30, 45),        # Empty grid cell
    "wall": (10, 10, 20),        # Near-black wall
    "start": (0, 255, 150),      # Bright cyan-green start
    "end": (255, 80, 100),       # Bright red/pink end
    "visited": (60, 120, 220),     # Deep blue visited
    "frontier": (120, 90, 180),    # Purple for A* frontier
    "path": (0, 255, 180),        # Bright cyan path
}
